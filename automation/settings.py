...
SECRET_KEY = 'django-insecure-y4w0t=-*3oo)$o9mm3(&j(@*uxb^h$=v6cwk0gzc%eo(@7+@@6'
...
ORACLE_CLIENTPATH = os.getenv('ORACLE_CLIENTPATH')
...
CELERY_TIMEZONE = 'Asia/Kuwait'  # or your timezone
